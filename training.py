...
def normalize(dataset):
  ...
  dataset = np.array(dataset).reshape((-1,) + TRACK_SHAPE + (1,))
...
if __name__ == '__main__':
  ...
  model = tf.keras.models.Sequential([
    tf.keras.layers.Conv2D(32, (3,3), padding='same', activation='relu', input_shape=(128, 1288, 1)),
